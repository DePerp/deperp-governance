...
import { GovernorBravoDelegateStorageV2, GovernorBravoEvents, TimelockInterface, DeperpInterface, GovernorAlphaInterface } from "./GovernorBravoInterfaces.sol";

/// @custom:security-contact security@deperp.com
contract GovernorBravoDelegate is
    GovernorBravoDelegateStorageV2,
    GovernorBravoEvents
{
    /// @notice The name of this contract
    string public constant name = "Deperp Governor Bravo";

    /// @notice The minimum settable proposal threshold
    uint public constant MIN_PROPOSAL_THRESHOLD = 1000000e18; // 1,000,000 Deperp

    /// @notice The maximum settable proposal threshold
    uint public constant MAX_PROPOSAL_THRESHOLD = 10000000e18; //10,000,000 Deperp
    ...
    uint public constant quorumVotes = 15000000e18; // 15,000,000 = 15% of Deperp
     ...
     * @param deperp_ The address of the DEPERP token
    ...
    function initialize(
        ...
        require(
            deperp_ != address(0),
            "GovernorBravo::initialize: invalid deperp address"
        );
        require(
    ...
    function proposeInternal(
        ...
        require(
            deperp.getPriorVotes(proposer, block.number - 1) >
                proposalThreshold ||
    ...
    function cancel(uint proposalId) external {
        ...
        if (msg.sender != proposal.proposer) {
            ...
            if (isWhitelisted(proposal.proposer)) {
                require(
                    (deperp.getPriorVotes(proposal.proposer, block.number - 1) <
